...
public class fReserva {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String [] titulos = {"ID", "IdHabitación", "Numero", "IdCliente", "Cliente", "IdTrabajador", "Trabajador", "Tipo Reserva", "Fecha Reserva", "Fecha Ingreso", "Fecha Salido", "Costo", "Estado"};
    ...
    public boolean insertar (vReserva dts){
        sSQL="insert into producto (idhabitacion,idcliente,idtrabajador,tipo_reserva,fecha_ingresa,fecha_salida,costo_alojamiento,estado)"+
                "values (?,?,?,?,?,?,?,?,?)";
        try {
            ...
            pst.setDouble(8, dts.getCosto_alojamineto());
